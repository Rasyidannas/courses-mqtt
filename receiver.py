...
class DroneCommandProcessor:
    ...
    def __init__(self, name, drone):
        ...
        # commands for publish topic and processedcommands for subscribe topic
    ...
    def on_message(client, userdata, msg):
        ...
        if msg.topic == DroneCommandProcessor.commands_topic:
            ...
            try:
                # for validation a message following the command.py file
                message_dictionary = json.loads(payload_string)
                print(f'message_dictionary: {message_dictionary}')
...
#### SIMPLE CODE FOR RECIEVE MESSAGE ####
# def on_connect(client, userdata, flags, rc):
